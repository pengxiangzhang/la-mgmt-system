...
FormBuilder.create(formname: 'application', formdata: '[{"type":"number","required":true,"label":"NUID","className":"form-control","name":"NUID","min":1,"max":99999999,"step":1},{"type":"text","required":true,"label":"Name:","className":"form-control","name":"Name","subtype":"text"},{"type":"text","subtype":"email","required":true,"label":"Email","className":"form-control","name":"Email"},{"type":"checkbox-group","required":true,"label":"Course Applying","toggle":false,"inline":true,"name":"Course","values":[{"label":"CSCE155","value":"CSCE155","selected":false},{"label":"CSCE156","value":"CSCE156","selected":false},{"label":"CSCE235","value":"CSCE235","selected":false}]},{"type":"radio-group","required":true,"label":"CSCE155","inline":true,"name":"CSCE155","values":[{"label":"Not applying for this class","value":"Z","selected":true},{"label":"A+","value":"A+","selected":false},{"label":"A","value":"A","selected":false},{"label":"A-","value":"A-","selected":false},{"label":"B+","value":"B+","selected":false}]},{"type":"radio-group","required":true,"label":"CSCE156","inline":true,"name":"CSCE156","values":[{"label":"Not applying for this class","value":"Z","selected":true},{"label":"A+","value":"A+","selected":false},{"label":"A","value":"A","selected":false},{"label":"A-","value":"A-","selected":false},{"label":"B+","value":"B+","selected":false}]},{"type":"radio-group","required":true,"label":"CSCE235","inline":true,"name":"CSCE235","values":[{"label":"Not applying for this class","value":"Z","selected":true},{"label":"A+","value":"A+","selected":false},{"label":"A","value":"A","selected":false},{"label":"A-","value":"A-","selected":false},{"label":"B+","value":"B+","selected":false}]},{"type":"number","required":true,"label":"GPA","className":"form-control","name":"GPA","max":4,"step":0.1},{"type":"file","required":false,"label":"File Upload","description":"Note: It can only upload PDF file, Can only have one file uploader through out the form.","className":"form-control","name":"File","subtype":"file","multiple":true}]')
FormBuilder.create(formname: 'interview', formdata: '[{"type":"text","required":true,"label":"Applicant Username","description":"MyUNL Username(Canvas)","className":"form-control","name":"username","subtype":"text","maxlength":99},{"type":"number","required":true,"label":"Score","description":"It will add to the total score","className":"form-control","name":"Score","step":1},{"type":"radio-group","required":true,"label":"Recommend to hire?","inline":true,"name":"Recommand-to-hire","other":false,"values":[{"label":"Yes","value":"yes","selected":false},{"label":"No","value":"no","selected":false}]},{"type":"file","required":false,"label":"Attachment","description":"Note: It can only upload PDF file, Can only have one file uploader through out the form when editing the form.","className":"form-control","name":"file","subtype":"file","multiple":true}]')
